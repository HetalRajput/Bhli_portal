...
const communities = [
  ["Armed Forces", Medal],
  ["Paramilitary Forces", Shield],
  ["Government Employees", Landmark],
  ["PSU Employees", Building2],
  ["Their Families", UsersRound],
] as const;
