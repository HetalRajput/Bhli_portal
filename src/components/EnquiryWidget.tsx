...
export default function EnquiryWidget() {
  ...
  return (
    <>
      <a
        href="https://wa.me/919945123211?text=Hello%20BHLI%2C%20I%20need%20help%20with%20a%20booking."
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Chat with BHLI on WhatsApp"
        title="WhatsApp support"
        className="group fixed bottom-24 right-5 z-[70] grid size-14 place-items-center rounded-full border border-white/60 bg-gradient-to-br from-[#128C5B] to-[#25D366] text-white shadow-[0_12px_30px_rgba(16,120,65,.35)] transition duration-300 hover:-translate-y-1 sm:bottom-28 sm:right-7"
      >
      ...
      <button
        ...
        className="group fixed bottom-5 right-5 z-[70] grid size-14 place-items-center rounded-full border border-white/40 bg-gradient-to-br from-[#03182e] via-[#062b50] to-[#074a78] text-white shadow-[0_12px_35px_rgba(2,20,40,.45)] transition duration-300 hover:-translate-y-1 sm:bottom-7 sm:right-7"
      >
        <span className="relative grid size-10 place-items-center rounded-full bg-white/10">
