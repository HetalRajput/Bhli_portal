...
export const documentedBookingConfigs: Record<string, BookingConfig> = {
  ...
  "event-management": { title: "Event Management", description: "Describe your event, audience and requirements.", fields: [text("name", "Full name"), text("email", "Email"), text("phone", "Phone number"), date("event_date", "Event date"), text("city", "City", "Optional", false), time("event_time", "Event time", false), text("event_location", "Event location", "Optional", false), { key: "budget_amount", label: "Budget amount", kind: "decimal", min: 0, required: false }, { key: "party_balloon", label: "Balloon decoration", kind: "checkbox", defaultValue: false }, { key: "party_flower", label: "Flower decoration", kind: "checkbox", defaultValue: false }, { key: "party_corporate", label: "Corporate events", kind: "checkbox", defaultValue: false }, { key: "party_artist", label: "Artist management", kind: "checkbox", defaultValue: false }, { key: "party_diy", label: "Decor yourself", kind: "checkbox", defaultValue: false }, { key: "event_theme", label: "Event theme", kind: "select", required: false, options: select("boy", "girl", "corporate", "neutral", "custom") }, { key: "requirements", label: "Event requirements", kind: "textarea", required: false, placeholder: "Stage, AV, catering and anything else you need" }] },
  ...
  "holiday-packages": { title: "Holiday Package", description: "Tell us where and when you want to travel.", fields: [text("contact_name", "Contact name"), text("email_address", "Email address"), text("mobile_number", "Mobile number"), { key: "package_category", label: "Package category", kind: "select", required: true, options: select("domestic", "international") }, text("destination", "Destination"), text("departure_city", "Departure city"), date("travel_date", "Travel date"), count("duration_days", "Duration (days)"), { key: "number_of_adults", label: "Number of adults", kind: "number", min: 1, required: true, defaultValue: "1" }, { key: "number_of_children", label: "Number of children", kind: "number", min: 0, required: false, defaultValue: "0" }, { key: "number_of_infants", label: "Number of infants", kind: "number", min: 0, required: false, defaultValue: "0" }, { key: "ltc_tier", label: "LTC tier", kind: "select", required: false, options: select("budget", "silver", "gold", "platinum", "premium") }, text("budget_category", "Budget category", "For example: Silver", false), text("hotel_preference", "Hotel preference", "Budget Hotels/Resorts", false), text("services_required", "Services required", "Breakfast, Sightseeing", false), { key: "special_requirements", label: "Special requirements", kind: "textarea", required: false, placeholder: "Meals, accessibility or other requirements" }] },
